...
imieniny[11] = Array();
imieniny[12] = Array();
imieniny[1][1] = "Masława, Mieczysława, Mieszka";
...
imieniny[1][12] = "Bernarda, Czesławy, Grety";
imieniny[1][13] = "Bogumiła, Bogumiły, Weroniki";
imieniny[1][14] = "Feliksa, Hilarego, Martyny";
imieniny[1][15] = "Arnolda, Dory, Pawła";
imieniny[1][16] = "Mascelego, Walerii, Włodzimierza";
imieniny[1][17] = "Antoniego, Henryki, Mariana";
imieniny[1][18] = "Beatrycze, Małgorzaty, Piotra";
imieniny[1][19] = "Erwiny, Henryka, Mariusza";
imieniny[1][20] = "Fabioli, Miły, Sebastiana";
imieniny[1][21] = "Agnieszki, Jarosława, Nory";
imieniny[1][22] = "Dominiki, Mateusza, Wincentego";
imieniny[1][23] = "Fernandy, Jana, Rajmundy";
imieniny[1][24] = "Felicji, Roberta, Sławy";
imieniny[1][25] = "Miłosza, Pawła, Tatiany";
imieniny[1][26] = "Lutosława, Normy, Pauliny";
imieniny[1][27] = "Anieli, Juliana, Przemysława";
imieniny[1][28] = "Agnieszki, Kariny, Lesława";
...
imieniny[2][3] = "Błażeja, Joanny, Telimeny";
...
imieniny[4][1] = "Chryzamtyny, Grażyny, Zygmunta";
imieniny[4][2] = "Franciszka, Malwiny, Władysława";
imieniny[4][3] = "Pankracego, Renaty, Ryszarda";
imieniny[4][4] = "Benedykta, Izodory, Wacławy";
...
imieniny[4][10] = "Borysławy, makarego, Michała";
imieniny[4][11] = "Filipa, Izoldy, Leona";
imieniny[4][12] = "Juliusza, Lubosława, Wiktoryny";
imieniny[4][13] = "Artemona, Justyny, Przemysławy";
imieniny[4][14] = "Bernarda, Martyny, Waleriana";
imieniny[4][15] = "Adolfiny, Odetty, Wacława";
imieniny[4][16] = "Bernarda, Biruty, Erwina";
imieniny[4][17] = "Anicety, Klary, Rudolfina";
imieniny[4][18] = "Apoloniusza, Bogusławy, Go¶cisławy";
imieniny[4][19] = "Alfa, Leonii, Tytusa";
imieniny[4][20] = "Agnieszki, Amalii, Czecha";
imieniny[4][21] = "Jarosława, Konrada, Selmy";
imieniny[4][22] = "Łukasza, Kai, Nastazji";
imieniny[4][23] = "Ilony, Jerzego, Wojciecha";
imieniny[4][24] = "Bony, Horacji, Jerzego";
imieniny[4][25] = "Jarosława, Marka, Wiki";
...
imieniny[5][3] = "Jaropełka, Marii, Niny";
imieniny[5][4] = "Floriana, Michała, Moniki";
imieniny[5][5] = "Irydy, Tamary, Waldemara";
imieniny[5][6] = "Beniny, Filipa, Judyty";
imieniny[5][7] = "Augusta, Gizeli, Ludomiry";
imieniny[5][8] = "Kornela, Lizy, Stanisława";
...
imieniny[5][16] = "Andrzeja, Jędrzeja, Małgorzaty";
imieniny[5][17] = "Brunony, Sławomira, Wery";
...
imieniny[6][7] = "Ariadny, Jarosława, Roberta";
imieniny[6][8] = "Ady, Celii, Medarda";
imieniny[6][9] = "Anny-Marii, Felicjana, Sławoja";
imieniny[6][10] = "Bogumiła, Diany, Małgorzaty";
...
imieniny[6][18] = "Elżbiety, Marka, Pauli";
imieniny[6][19] = "Gerwazego, Protazego, Sylwii";
imieniny[6][20] = "Bogny, Rafaeli, Rafała";
...
imieniny[6][25] = "Łucji, Witolda, Wilhelma";
imieniny[6][26] = "Jana, Pauliny, Rudolfiny";
imieniny[6][27] = "Cypriana, Emanueli, Władysława";
imieniny[6][28] = "Florentyny, Ligii, Leona";
imieniny[6][29] = "Pawła, Piotra, Salomei";
imieniny[6][30] = "Arnolda, Emiliany, Lucyny";
imieniny[7][1] = "Bogusza, Haliny, Mariana";
imieniny[7][2] = "Kariny, Serafiny, Urbana";
imieniny[7][3] = "Anatola, Jacka, Mirosławy";
imieniny[7][4] = "Aureli, Malwiny, Zygfryda";
imieniny[7][5] = "Antoniego, Bartłomieja, Karoliny";
imieniny[7][6] = "Dominiki, Jaropełka, Łucji";
imieniny[7][7] = "Estery, Kiry, Rudolfa";
imieniny[7][8] = "Arnolda, Edgara, Elżbiety";
...
imieniny[7][13] = "Danieli, Irwina, Małgorzaty";
imieniny[7][14] = "Kamili, Kamila, Marcelego";
imieniny[7][15] = "Henryka, Igi, Włodzimierza";
...
imieniny[7][20] = "Fryderyka, Małgorzaty, Seweryny";
imieniny[7][21] = "Danieli, Wawrzyńca, Wiktora";
imieniny[7][22] = "Magdaleny, Mileny, Wawrzyńca";
imieniny[7][23] = "Sławy, Sławosza, Żelisławy";
imieniny[7][24] = "Kingi, Krystyna, Michaliny";
imieniny[7][25] = "jakuba, Krzysztofa, Walentyny";
imieniny[7][26] = "Anny, Mirosławy, Joachima";
imieniny[7][27] = "Aureliusza, Natalii, Rudolfa";
imieniny[7][28] = "Ady, Wiwiany, Sylwiusza";
imieniny[7][29] = "Marty, Konstantego, Olafa";
imieniny[7][30] = "Julity, Ludmiły, Zdobysława";
imieniny[7][31] = "Ignacego, Lodomiry, Romana";
imieniny[8][1] = "Jarosława, Justyny, Nadziei";
...
imieniny[8][6] = "Jakuba, Sławy, Wincentego";
imieniny[8][7] = "Donaty, Olechny, Kajetana";
imieniny[8][8] = "Izy, Rajmunda, Seweryna";
imieniny[8][9] = "Klary, Romana, Rozyny";
imieniny[8][10] = "Bianki, Borysa, Wawrzyńca";
imieniny[8][11] = "Luizy, Włodzmierza, Zuzanny";
imieniny[8][12] = "Hilarii, Juliana, Lecha";
imieniny[8][13] = "Elwiry, Hipolita, Radosławy";
...
imieniny[8][18] = "Bogusława, Bronisława, Ilony";
...
imieniny[8][23] = "Apolinarego, Miły, Róży";
imieniny[8][24] = "Bartosza, Jerzego, Maliny";
imieniny[8][25] = "Belii, Ludwika, Luizy";
imieniny[8][26] = "Ireneusza, Konstantego, Marii";
imieniny[8][27] = "Cezarego, Małgorzaty, Moniki";
imieniny[8][28] = "Adeliny, Erazma, Sobiesława";
imieniny[8][29] = "Beaty, Racibora, Sabiny";
imieniny[8][30] = "Benona, Jowity, Szczęsnego";
...
imieniny[9][5] = "Doroty, Justyna, Wawrzyńca";
...
imieniny[9][10] = "Eligii, Irmy, Łukasza";
...
imieniny[9][18] = "Ireny, Irminy, Stanisława";
imieniny[9][19] = "Januarego, Konstancji, Leopolda";
imieniny[9][20] = "Eustachego, Faustyny, Renaty";
imieniny[9][21] = "Darii, Mateusza, Wawrzyńca";
imieniny[9][22] = "Maury, Milany, Tomasza";
imieniny[9][23] = "Bogusława, Liwiusza, Tekli";
imieniny[9][24] = "Dory, Gerarda, Maryny";
imieniny[9][25] = "Aureli, Kamila, Kleofasa";
imieniny[9][26] = "Cypriana, Justyny, Łucji";
imieniny[9][27] = "Damiana, Mirabeli, Wincentego";
imieniny[9][28] = "Libuszy, Wacławy, Wacława";
imieniny[9][29] = "Michaliny, Michała, Rafała";
imieniny[9][30] = "Geraldy, Honoriusza, Wery";
imieniny[10][1] = "Heloizy, Igora, Remigiusza";
imieniny[10][2] = "Racheli, Sławy, Teofila";
imieniny[10][3] = "Bogumiła, Gerarda, Józefy";
imieniny[10][4] = "Edwina, Rosławy, Rozalii";
...
imieniny[11][19] = "Elżbiety, Faustyny, Pawła";
imieniny[11][20] = "Anatola, Edyty, Rafała";
...
imieniny[11][25] = "Elżbiety, Katarzyny, Klemensa";
imieniny[11][26] = "Leona, Leonarda, Lesławy";
imieniny[11][27] = "Franciszka, Kseni, Maksymiliana";
imieniny[11][28] = "Jakuba, Stefana, Romy";
imieniny[11][29] = "Błażeja, Margerity, Saturnina";
...
imieniny[12][6] = "Dionizji, Leontyny, Mikołaja";
imieniny[12][7] = "Agaty, Dalii, Sobiesława";
imieniny[12][8] = "Delfiny, Marii, Wirginiusza";
imieniny[12][9] = "Anety, Leokadii, Wiesława";
imieniny[12][10] = "Danieli, Bohdana, Julii";
imieniny[12][11] = "Biny, Damazego, Waldemara";
imieniny[12][12] = "Ady, Aleksandra, Dagmary";
imieniny[12][13] = "Dalidy, Juliusza, Łucji";
imieniny[12][14] = "Alfreda, Izydora, Zoriny";
imieniny[12][15] = "Celiny, Ireneusza, Niny";
imieniny[12][16] = "Albiny, Sebastiana, Zdzisławy";
imieniny[12][17] = "Jolanty, Łukasza, Olimpii";
imieniny[12][18] = "Bogusława, Gracjana, Laury";
imieniny[12][19] = "Beniaminy, Dariusza, Gabrieli";
imieniny[12][20] = "Bogumiły, Dominika, Zefiryna";
imieniny[12][21] = "Honoraty, Seweryny, Tomasza";
imieniny[12][22] = "Bożeny, Drogomira, Zenona";
imieniny[12][23] = "Dagny, Sławomiry, Wiktora";
imieniny[12][24] = "Adama, Ewy, Irminy";
imieniny[12][25] = "Anety, Glorii, Piotra";
imieniny[12][26] = "Dionizego, Kaliksta, Szczepana";
imieniny[12][27] = "Fabioli, Jana, Żanety";
...
imieniny[0] = imieniny[1];
imieniny[1] = imieniny[2];
imieniny[2] = imieniny[3];
imieniny[3] = imieniny[4];
imieniny[4] = imieniny[5];
imieniny[5] = imieniny[6];
imieniny[6] = imieniny[7];
imieniny[7] = imieniny[8];
imieniny[8] = imieniny[9];
imieniny[9] = imieniny[10];
imieniny[10] = imieniny[11];
imieniny[11] = imieniny[12];